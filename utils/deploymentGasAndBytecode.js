...
const ARBITRARY_ADDRESS = "0x8A7016D98d241f9A14beC49EB505BA60005E82AB"   // Dev2, placeholder for the LPrewards bounty addresses
...
const logContractDeploymentCosts = async (contracts) => {
  ...
  getUSDCostFromGasCost(totalGasCost, 0.06, 32000)
}
