...
contract CommunityIssuance is ICommunityIssuance, Ownable, CheckContract, BaseMath {
    ...
    *
    * For 10% of remaining tokens issued each year, with minutes as time units, we have:
    * 
    * F ** 525600 = 0.9
    * 
    * Re-arranging:
    ...
    * 525600 * ln(F) = ln(0.9)
    * F = 0.9 ** (1/525600)
    * F = 0.999999799542418003
    */
    uint constant public ISSUANCE_FACTOR = 999999799542418003;
    ...
    * 
    * Set to 21M (slightly less than 1/3) of total CAL supply.
    */
    uint constant public LQTYSupplyCap = 2079e22; // 21 million - 210000(LP Reward)
